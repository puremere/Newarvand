...
namespace realstate.ListOfAdds
{
    ...
    public class item
    {
        ...
        public string sanad { get; set; }
        public string takhlie { get; set; }
        public int tabaghe1 { get; set; }
        public int zirbana1 { get; set; }
        ...
        public string anbari1 { get; set; }
        public string asansor1 { get; set; }
        public int tabaghe2 { get; set; }
        public int zirbana2 { get; set; }
        ...
        public string anbari2 { get; set; }
        public string asansor2 { get; set; }
        public int tabaghe3 { get; set; }
        public int zirbana3 { get; set; }
        ...
        public string anbari3 { get; set; }
        public string asansor3 { get; set; }
        public int tabaghe_1_total_price { get; set; }
        public int tabaghe_2_total_price { get; set; }
        public int tabaghe_3_total_price { get; set; }
        public int tabaghe_4_total_price { get; set; }
        public int tabaghe_1_rahn { get; set; }
        public int tabaghe_2_rahn { get; set; }
        public int tabaghe_3_rahn { get; set; }
        public int tabaghe_4_rahn { get; set; }
        public int tabaghe_1_ejare { get; set; }
        public int tabaghe_2_ejare { get; set; }
        public int tabaghe_3_ejare { get; set; }
        public int tabaghe_4_ejare { get; set; }
        public int tabaghe_1_metri { get; set; }
        public int tabaghe_2_metri { get; set; }
        public int tabaghe_3_metri { get; set; }
        public int tabaghe_4_metri { get; set; }
        public int masahat_zamin { get; set; }
        public string senn { get; set; }
        public string ashpazkhane { get; set; }
        public string tarakom { get; set; }
        public string toole_bar { get; set; }
